...
class MtMaxSettingsRollout(MtRollout):
    ...
    def loadConfig():
        ...
        if mtmaxconfig.target >= len(target.supported):
            mtmaxconfig.target = 0
        self.ddlGame.selection = mtmaxconfig.target+1
        target.setTarget( target.supported[mtmaxconfig.target].name )
        self.chkLukasCompat.checked = mtmaxconfig.lukasCompat
...
class MtMaxModelImportRollout(MtRollout):
    ...
    @staticmethod
    def btnFilePressed():
        path = mtmaxutil.selectOpenFile( 'MT Framework model', 'mod' )
        if path == None:
            return
    ...
    def btnMetadataPressed():
        path = mtmaxutil.selectOpenFile( 'MT Framework model metadata', 'yml' )
        if path == None:
            return
...
class MtMaxModelExportRollout(MtRollout):
    ...
    @staticmethod
    def btnFilePressed():
        path = mtmaxutil.selectSaveFile( 'MT Framework model', 'mod' )
        if path == None:
            return
    ...
    def btnMrlYmlPressed():
        path = mtmaxutil.selectOpenFile( 'MT Framework MRL YML', 'yml' )
        if path == None:
            return
...
class MtMaxDebugRollout(MtRollout):
    ...
    def loadConfig():
        ...
        self.chkDisableTransform.checked = mtmaxconfig.debugDisableTransform
    ...
    def chkDisableTransformChanged( state ):
        mtmaxconfig.debugDisableTransform = state
